...
with open('../data/3d_svm_mesh.sav', 'rb') as in_mesh:
...
fig.legend(handles, legend_labels, fontsize=70, 
          bbox_to_anchor=(1.35,0.7), markerscale=12)

fig.savefig("../plots/3d_svm_detector.pdf", dpi=700, 
